...
class Order extends Generator {
	...
	public function generate( $save = true, $assoc_args = array() ) {
		...
		$date  = $this->get_date_created( $assoc_args );
	...
	public static function get_customer() {
		...
		return $customer->generate( ! $guest );
	}
	 ...
	 */
	private function get_date_created( $assoc_args ) {
	 ...
	 */
	private function get_random_products( int $min_amount = 1, int $max_amount = 4 ) {
		global $wpdb;
